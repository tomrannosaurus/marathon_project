...
:::{.content-hidden}
*TODO*
[] Alter AQI handling as noted in paragraph above. We add to the inital AQI dataset three new variables, carbon monoxide (CO), nitrogen dioxide (NO2), and sulfer dioxide (SO2)
[x] Fix code to reflect new handling of AQI variables
[] For updated aggregation cite AQI formula as the reason we grab the new parameters: https://document.airnow.gov/technical-assistance-document-for-the-reporting-of-daily-air-quailty.pdf
